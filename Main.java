            ...
            if (menuOption == 1) {
                ...
                for (int i = 0; i < listaItens.length; i++) {
                    ...
                    if (listaItens[i].getEstab().getNomeEstab().equals(estabEscolhido.getNomeEstab())) {
                        ...
                        System.out.println("[ " + listaItens[i].getCodItem() + " ]" + " R$ "
                                + listaItens[i].getPrecoItem() + " - " + listaItens[i].getNomeItem());
                    }
                }
                ...
                System.out.println("");
                System.out.println(
                        "Para incluir itens no pedido, digite o código do produto e a quantidade. Aqui, você C-Food e só pode escolher 3 itens por pedido. :) ");
                System.out.println("");
                ...
                System.out.println("---------------------------------------");
                System.out.println("Acompanhamento do Pedido: ");
                System.out.println("---------------------------------------");
                System.out.println("Pedido: " + codPedido);
                System.out.println("---------------------------------------");
                System.out.println("Status: " + "Em Preparo");
                System.out.println("---------------------------------------");
                System.out.println("Entregador: " + "João");
                System.out.println("---------------------------------------");
                System.out.println("Tempo Estimado: " + "30 minutos");
                System.out.println("---------------------------------------");
                System.out.println("Valor Total: " + "R$ 50,00");
                System.out.println("---------------------------------------");
