public class CatalogoDeItens {
    ...
    public CatalogoDeItens() {
        ...
        catalogoDeItens[4] = new Item(0005, catEstabs.getEstabs()[1], "Trakinas Chocolate 270g", "Biscoitos", 2.75);
        catalogoDeItens[5] = new Item(0006, catEstabs.getEstabs()[2], "Trakinas Chocolate 270g", "Biscoitos", 2.75);
